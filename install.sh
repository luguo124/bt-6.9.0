...
if [ -f "/usr/bin/apt-get" ];then
	...
	if [ "$isDebian" != "" ];then
		wget -O install.sh https://loli.team/bt5/install/install-ubuntu.sh && bash install.sh
		exit;
	else
		wget -O install.sh https://loli.team/bt5/install/install-ubuntu.sh && sudo bash install.sh
		exit;
	fi
fi
